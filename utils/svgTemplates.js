...
exports.generateDevtoTemplate = exports.generateMediumTemplate = void 0;
const generateMediumTemplate = ({ mediumArticles, styles = { width: 700, height: 120 } }) => {
    const numOfArticles = mediumArticles.length;
    const front = `<svg fill="none" width="800" height="${numOfArticles * styles.height}" xmlns="http://www.w3.org/2000/svg">
...
exports.generateMediumTemplate = generateMediumTemplate;
const generateDevtoTemplate = ({ devtoArticles, styles = { width: 400, height: 300 } }) => {
    let cardBody = "";
...
exports.generateDevtoTemplate = generateDevtoTemplate;
//# sourceMappingURL=svgTemplates.js.map